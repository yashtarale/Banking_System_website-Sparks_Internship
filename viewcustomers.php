...
<div class="usertable">
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:black;font-family: 'Copperplate Gothic Light', cursive;font-size:2.2em;padding:3%;">C U S T O M E R S  -  D E T A I L S</h3>
  ...
  <thead>
    ...
    <th>Customer ID</th>
        ...
        while($row = mysqli_fetch_assoc($result)){
           ...
           echo "<td> <a href='acustomer.php'><button type='submit' class='btn btn-default' name='user' 
                        id='users1' value= '{$row['name']}' >Details and Transfer</button></a></td>";
            echo "</form>";
           echo  "</tr>";
        }
        ?>
